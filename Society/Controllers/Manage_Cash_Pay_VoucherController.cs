...
{
    public class Manage_Cash_Pay_VoucherController : Controller
    {
        lakeViewNewDbEntities3 dbm = new lakeViewNewDbEntities3();
        // GET: Cash_Pay_Voucher
        public ActionResult Manage_Cash_Pay_Voucher()
        {
            ...
            dy.Pending_Amount = dbm.reciept_vouchers.Where(o => o.Type == "CPV").ToList();
