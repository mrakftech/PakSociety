...
{
    public class Manage_Bank_Pay_VoucherController : Controller
    {
        lakeViewNewDbEntities3 dbm = new lakeViewNewDbEntities3();
        // GET: Manage_Bank_Pay_Voucher
        public ActionResult Manage_Bank_Pay_Voucher()
        {
            ...
            dy.Pending_Amount = dbm.reciept_vouchers.Where(o => o.Type == "BPV").ToList();
